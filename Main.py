...
earnings_users = df_all[df_all['earnings'].fillna('').str.strip() == 'onboarded']['user_email'].nunique()
briefing_users = df_all[df_all['briefing'].fillna('').str.strip() == 'onboarded']['user_email'].nunique()
